...
def main():
    ...
    for experiment_number in range(experiment_repeat):
        ...
        model = FTTransformer(
            ...
            n_blocks=1,
            d_block=480,
            ffn_d_hidden_multiplier=1.0611438742669064,
            residual_dropout=0.09092017297623414,
            attention_dropout=0.21463264368569207,
            ffn_dropout=0.1106467829778876,
        ...
        optimizer = torch.optim.AdamW(model.parameters(), lr=0.00021962762166300023, weight_decay=1.958489272610056e-06)
