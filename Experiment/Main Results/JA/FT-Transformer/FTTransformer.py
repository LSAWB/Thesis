...
def main():
    ...
    for experiment_number in range(experiment_repeat):
        ...
        model = FTTransformer(
            ...
            n_blocks=1,
            d_block=312,
            ffn_d_hidden_multiplier=2.237746556120782,
            residual_dropout=0.11625430773431698,
            attention_dropout=0.2765118706272076,
            ffn_dropout=0.27294672311275436,
        ...
        optimizer = torch.optim.AdamW(model.parameters(), lr=0.00022842185150323113, weight_decay=1.8408543846824476e-06)
