...
class DualTransformer(nn.Module):
    def __init__(self, 
        ...
        self.pos_embeddings = nn.Parameter(
            torch.randn(1, (total_tokens*2), dim_model)  # +1 for CLS
        )

        # === Transformer Layers ===
        self.StackedTwoStageAttention = StackedTwoStageAttention(
    ...
    def forward(self, cat_data, num_data, bte_data):
        ...
        # === Attention ===
        final_out, _, _= self.StackedTwoStageAttention(all_emb)
